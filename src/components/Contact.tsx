  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "tusharya9876@gmail.com",
      href: "mailto:tusharya9876@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 9821426743",
      href: "tel:+919821426743"
    },
    {
      icon: MapPin,
      label: "Location",
  ...
  const socialLinks = [
    {
      icon: Github,
      label: "GitHub",
      href: "https://github.com/tusharya8285",
      color: "hover:text-gray-400"
    },
    {
      icon: Linkedin,
      label: "LinkedIn", 
      href: "https://linkedin.com/in/tusharya8285",
